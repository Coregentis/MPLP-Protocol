...
const mplp_security_json_1 = tslib_1.__importDefault(require("./mplp-security.json"));
exports.SecuritySchema = mplp_security_json_1.default;
const mplp_performance_json_1 = tslib_1.__importDefault(require("./mplp-performance.json"));
exports.PerformanceSchema = mplp_performance_json_1.default;
// ===== EVENTS & ERROR HANDLING INFRASTRUCTURE =====
const mplp_event_bus_json_1 = tslib_1.__importDefault(require("./mplp-event-bus.json"));
exports.EventBusSchema = mplp_event_bus_json_1.default;
const mplp_error_handling_json_1 = tslib_1.__importDefault(require("./mplp-error-handling.json"));
exports.ErrorHandlingSchema = mplp_error_handling_json_1.default;
// ===== COORDINATION & ORCHESTRATION INFRASTRUCTURE =====
const mplp_coordination_json_1 = tslib_1.__importDefault(require("./mplp-coordination.json"));
exports.CoordinationSchema = mplp_coordination_json_1.default;
const mplp_orchestration_json_1 = tslib_1.__importDefault(require("./mplp-orchestration.json"));
exports.OrchestrationSchema = mplp_orchestration_json_1.default;
const mplp_state_sync_json_1 = tslib_1.__importDefault(require("./mplp-state-sync.json"));
exports.StateSyncSchema = mplp_state_sync_json_1.default;
// ===== TRANSACTION & PROTOCOL MANAGEMENT INFRASTRUCTURE =====
const mplp_transaction_json_1 = tslib_1.__importDefault(require("./mplp-transaction.json"));
exports.TransactionSchema = mplp_transaction_json_1.default;
const mplp_protocol_version_json_1 = tslib_1.__importDefault(require("./mplp-protocol-version.json"));
