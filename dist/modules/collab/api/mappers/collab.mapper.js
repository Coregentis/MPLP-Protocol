...
class CollabMapper {
    ...
    static fromSchema(schema) {
        return {
            // ===== BASIC PROTOCOL FIELDS =====
            id: schema.collaboration_id, // Map collaboration_id to both id and collaborationId
    ...
    static fromUpdateDTO(dto) {
        ...
        if (dto.participants) {
            updateData.participants = dto.participants.map(p => ({
                ...
                agentId: '', // Will be filled from existing data
                roleId: '', // Will be filled from existing data
...
//# sourceMappingURL=collab.mapper.js.map