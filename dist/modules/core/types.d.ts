...
export type WorkflowStageType = 'context' | 'plan' | 'confirm' | 'trace' | 'role' | 'extension' | 'collab' | 'dialog' | 'network';
export type WorkflowStatusType = 'created' | 'in_progress' | 'completed' | 'failed' | 'cancelled' | 'paused';
export type StageStatusType = 'pending' | 'running' | 'completed' | 'failed' | 'skipped';
export type CoreOperation = 'workflow_execution' | 'module_coordination' | 'resource_management' | 'system_monitoring' | 'error_recovery';
export type OrchestrationMode = 'centralized' | 'distributed' | 'hybrid';
export type ResourceAllocation = 'static' | 'dynamic' | 'adaptive';
export type FaultTolerance = 'none' | 'basic' | 'advanced';
...
export type EventType = 'workflow_created' | 'workflow_started' | 'workflow_completed' | 'workflow_failed' | 'workflow_cancelled' | 'stage_started' | 'stage_completed' | 'stage_failed' | 'module_connected' | 'module_disconnected' | 'data_transferred';
...
export type AuditEventType = 'workflow_started' | 'workflow_completed' | 'workflow_failed' | 'module_coordinated' | 'resource_allocated' | 'system_recovered' | 'cluster_scaled' | 'configuration_changed' | 'orchestration_updated';
...
export type ChangeType = 'system_initialized' | 'configuration_updated' | 'workflow_deployed' | 'cluster_scaled' | 'recovery_executed';
...
export type SearchableField = 'workflow_id' | 'orchestrator_id' | 'workflow_config' | 'execution_status' | 'system_metrics' | 'audit_logs' | 'metadata';
...
export type PublishedEvent = 'system_started' | 'system_stopped' | 'workflow_executed' | 'workflow_failed' | 'module_coordinated' | 'resource_allocated' | 'system_recovered' | 'cluster_scaled';
export type SubscribedEvent = 'context_updated' | 'plan_executed' | 'confirm_approved' | 'trace_completed' | 'role_assigned' | 'extension_activated' | 'dialog_started' | 'network_connected';
