...
| `@mplp/integration-llm-http` | HTTP LLM Client Adapter | `v1.0.4` | [npm](https://www.npmjs.com/package/@mplp/integration-llm-http) |
| `@mplp/integration-storage-fs` | File System Storage Adapter | `v1.0.4` | [npm](https://www.npmjs.com/package/@mplp/integration-storage-fs) |
| `@mplp/integration-storage-kv` | Key-Value Storage Adapter | `v1.0.4` | [npm](https://www.npmjs.com/package/@mplp/integration-storage-kv) |
| `@mplp/integration-tools-generic` | Generic Tool Executor | `v1.0.4` | [npm](https://www.npmjs.com/package/@mplp/integration-tools-generic) |
| `@mplp/validator` | Protocol Validator CLI (CI-only) | `v1.0.0` | *internal* |
