...
export class CoreServicesCoordinator {
  ...
  // Note: _updateMonitoringStatus and _checkResourceStatus methods were removed
  // as they are not currently used. Monitoring is handled by monitoringService.performHealthCheck()
  // and resource checking can be added when needed.
}
