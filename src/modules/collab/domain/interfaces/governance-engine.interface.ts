...
export interface ComplianceRule {
  ...
  remediationTimeframe: number; // in milliseconds
...
export interface IGovernanceEngine {
  ...
  createComplianceRule(
    rule: Omit<ComplianceRule, 'ruleId' | 'createdAt' | 'updatedAt'>,
    createdBy: UUID
  ): Promise<UUID>;
  ...
  createGovernancePolicy(
    policy: Omit<GovernancePolicy, 'policyId' | 'createdAt' | 'updatedAt'>,
    createdBy: UUID
  ): Promise<UUID>;
