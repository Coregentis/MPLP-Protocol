 ...
 * ```
 */
export async function createProductionMPLP(config?: Partial<MPLPConfig>): Promise<MPLP> {
  return createMPLP({
    environment: 'production',
    logLevel: 'error',
    ...config
 ...
 * ```
 */
export async function createTestMPLP(config?: Partial<MPLPConfig>): Promise<MPLP> {
  return createMPLP({
    environment: 'test',
    logLevel: 'warn',
    ...config
