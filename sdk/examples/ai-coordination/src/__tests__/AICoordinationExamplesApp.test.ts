/**
 * AI Coordination Example - Main Application Tests
 * Comprehensive test suite for the AI coordination system
 */

import AICoordinationExamplesApp from '../index';
import {
  PlannerAgent,
  CreatorAgent,
  ReviewerAgent,
...
describe('AICoordinationExamplesApp', () => {
  let app: AICoordinationExamplesApp;
  ...
  beforeEach(() => {
    ...
    mockCoordinator = {
      ...
      process: jest.fn().mockResolvedValue({
        ...
        status: 'completed',
        stages: [],
        final_output: { title: 'Test Content', content: 'Test content body' },
        execution_metadata: {
          started_at: new Date(),
    ...
    app = new AICoordinationExamplesApp();
  });

  describe('constructor', () => {
    it('should create an instance successfully', () => {
      expect(app).toBeInstanceOf(AICoordinationExamplesApp);
    });
  });
  ...
  describe('runExample', () => {
    ...
    it('should run basic-content example', async () => {
      await app.runExample('basic-content');
    ...
    it('should handle example execution errors', async () => {
      ...
      await expect(app.runExample('basic-content')).rejects.toThrow('Example error');
    });
  });
