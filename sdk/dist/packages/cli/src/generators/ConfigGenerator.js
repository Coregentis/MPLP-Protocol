 ...
 */
class ConfigGenerator extends CodeGeneratorManager_1.BaseGenerator {
    /**
...
`;
     ...
     */
    getEnvironmentConfigTemplate(environment, template) {
...
`;
     ...
     */
    getConfigTestTemplate(template) {
        return `/**
