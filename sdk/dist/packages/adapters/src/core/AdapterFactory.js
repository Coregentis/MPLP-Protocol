...
const TwitterAdapter_1 = require("../platforms/twitter/TwitterAdapter");
const LinkedInAdapter_1 = require("../platforms/linkedin/LinkedInAdapter");
const GitHubAdapter_1 = require("../platforms/github/GitHubAdapter");
const DiscordAdapter_1 = require("../platforms/discord/DiscordAdapter");
const SlackAdapter_1 = require("../platforms/slack/SlackAdapter");
const RedditAdapter_1 = require("../platforms/reddit/RedditAdapter");
const MediumAdapter_1 = require("../platforms/medium/MediumAdapter");
/**
...
class AdapterFactory {
     ...
     */
    createAdapter(platform, config) {
        switch (platform) {
            case 'twitter':
                return new TwitterAdapter_1.TwitterAdapter(config);
            case 'linkedin':
                return new LinkedInAdapter_1.LinkedInAdapter(config);
            case 'github':
                return new GitHubAdapter_1.GitHubAdapter(config);
            case 'discord':
                return new DiscordAdapter_1.DiscordAdapter(config);
            case 'slack':
                return new SlackAdapter_1.SlackAdapter(config);
            case 'reddit':
                return new RedditAdapter_1.RedditAdapter(config);
            case 'medium':
                return new MediumAdapter_1.MediumAdapter(config);
            case 'telegram':
            case 'custom':
     ...
     */
    createValidatedAdapter(platform, config) {
     ...
     */
    createAdaptersFromConfig(configs) {
