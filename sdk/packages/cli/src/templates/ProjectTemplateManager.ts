...
import { ProjectTemplate, ProjectOptions, TemplateFile } from '../core/types';
...
export class ProjectTemplateManager {
   ...
   */
  private loadTemplateFiles(templateDir: string): TemplateFile[] {
   ...
   */
  private getBasicTemplateFiles(): TemplateFile[] {
   ...
   */
  private getFallbackBasicTemplateFiles(): TemplateFile[] {
    return [
      {
        path: 'package.json',
...
`,
   ...
   */
  private getAdvancedTemplateFilesFallback(): TemplateFile[] {
    return [
      {
        path: 'src/index.ts',
        content: `/**
...
`
   ...
   */
  private getAdvancedTemplateFiles(): TemplateFile[] {
    ...
    const advancedFiles: TemplateFile[] = [
      {
...
`;
   ...
   */
  private getEnterpriseTemplateFiles(): TemplateFile[] {
    ...
    const enterpriseFiles: TemplateFile[] = [
      {
        path: '.env.example',
...
`,
   ...
   */
  public async createProject(options: ProjectOptions, targetPath: string): Promise<void> {
