...
export class WorkflowGenerator extends BaseGenerator {
   ...
   */
  private getWorkflowTemplate(template: string): string {
    switch (template) {
      case 'basic':
   ...
   */
  private getBasicWorkflowTemplate(): string {
    return `/**
...
`;
   ...
   */
  private getAdvancedWorkflowTemplate(): string {
    return `/**
 * @fileoverview {{name}} - {{description}}
 * Generated on {{date}}
 */
...
`;
   ...
   */
  private getEnterpriseWorkflowTemplate(): string {
    return `/**
 * @fileoverview {{name}} - {{description}}
 * Generated on {{date}}
 */
...
`;
   ...
   */
  private getWorkflowConfigTemplate(template: string): string {
...
`;
   ...
   */
  private getWorkflowTypesTemplate(): string {
    return `/**
...
`;
   ...
   */
  private getWorkflowTestTemplate(template: string): string {
    return `/**
...
`;
   ...
   */
  private getWorkflowReadmeTemplate(): string {
