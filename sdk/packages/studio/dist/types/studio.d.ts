 ...
 */
export type StudioEventType = 'initialized' | 'shutdown' | 'error' | 'projectCreated' | 'projectOpened' | 'projectClosed' | 'projectSaved' | 'projectDeleted' | 'projectSwitched' | 'allProjectsSaved' | 'workspaceChanged' | 'workspaceCreated' | 'workspaceOpened' | 'workspaceSaved' | 'agentCreated' | 'agentUpdated' | 'agentDeleted' | 'workflowCreated' | 'workflowUpdated' | 'workflowDeleted' | 'componentAdded' | 'componentRemoved' | 'componentUpdated' | 'configUpdated' | 'stateChanged' | 'preferencesUpdated';
/**
 * Studio事件数据
 */
