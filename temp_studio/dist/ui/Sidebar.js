 ...
 */
class Sidebar {
    constructor(config, eventManager, position = 'left') {
    ...
    setupEventListeners() {
        ...
        if (this.resizeHandle) {
            ...
            document.addEventListener('mousemove', (e) => {
                ...
                const newWidth = Math.max(this.sidebarConfig.minWidth, Math.min(this.sidebarConfig.maxWidth, startWidth + deltaX));
