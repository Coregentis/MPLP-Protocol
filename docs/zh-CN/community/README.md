...
3. **💬 加入讨论**: 参与[GitHub讨论](https://github.com/Coregentis/MPLP-Protocol/discussions)
4. **🤝 遵循指南**: 查看我们的[社区指南](./guidelines.md)

### **准备贡献？**

1. **📋 查看问题**: 浏览[开放问题](https://github.com/Coregentis/MPLP-Protocol/issues)寻找贡献机会
...
- **GitHub讨论**: [主要社区论坛](https://github.com/Coregentis/MPLP-Protocol/discussions)
- **GitHub问题**: [错误报告和功能请求](https://github.com/Coregentis/MPLP-Protocol/issues)
