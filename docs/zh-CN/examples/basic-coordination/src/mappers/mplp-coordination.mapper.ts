/**
 * MPLP协调示例Schema-TypeScript映射器
 * 
 * 基于实际MPLP v1.0 Alpha Schema的映射实现
 * 实现双重命名约定的映射函数：
 * - Schema层：snake_case (context_id, plan_id, trace_id)
 * - TypeScript层：camelCase (contextId, planId, traceId)
 * 
