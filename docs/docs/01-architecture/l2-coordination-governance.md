...
description: L2 layer defining domain logic, 10 Core Module lifecycles, SA/MAP
  execution profiles, coordination patterns, and governance mechanisms for MPLP
  v1.0.
keywords:
  - L2 Coordination
  - module lifecycle
...
spec_level: L2
normative_id: MPLP-L2-COORD
permalink: /architecture/l2-coordination-governance
cross_cutting:
  - coordination
normative_refs: []
protocol_alignment:
...
Modules opt-in to 9 concerns (from `metadata.schema.json`):
...
- [cross-cutting/coordination.md](cross-cutting/coordination.md)
