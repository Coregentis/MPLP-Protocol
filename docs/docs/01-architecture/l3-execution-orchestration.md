...
doc_type: normative
trace:
  schema: packages/sources/sdk-ts/src/runtime/
...
- [14-runtime/runtime-glue-overview.md](../14-runtime/runtime-glue-overview.md)
- [14-runtime/crosscut-psg-event-binding.md](../14-runtime/crosscut-psg-event-binding.md)
- [14-runtime/module-psg-paths.md](../14-runtime/module-psg-paths.md)
- [14-runtime/drift-and-rollback.md](../14-runtime/drift-and-rollback.md)

**Cross-Cutting**:
- [../14-runtime/ael.md](../14-runtime/ael.md)
- [../14-runtime/vsl.md](../14-runtime/vsl.md)
