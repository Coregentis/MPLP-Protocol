...
description: L3 runtime layer specification covering PSG (Project Semantic
  Graph), VSL, AEL, event bus, orchestration, drift detection, and rollback
  mechanisms.
keywords:
  - L3 Runtime
  - PSG
...
spec_level: L3
normative_id: MPLP-L3-EXEC
permalink: /architecture/l3-execution-orchestration
cross_cutting:
  - orchestration
normative_refs: []
protocol_alignment:
...
- **Module Lifecycles** (L2): State transition rules are normative, L3 implements them
...
4. **Immutable History**: Trace segments cannot be modified after creation
...
- MUST guarantee eventual consistency (for distributed VSL)
...
**Layering Rule**: L3 **implements** L2 semantics using L1 schemas, but cannot modify either
...
**Cross-Cutting**:
- [cross-cutting/ael.md](cross-cutting/ael.md)
- [cross-cutting/vsl.md](cross-cutting/vsl.md)
- [cross-cutting/orchestration.md](cross-cutting/orchestration.md)

**Compliance**:
- [08-guides/mplp-v1.0-compliance-guide.md](../08-guides/mplp-v1.0-compliance-guide.md)
