---
title: Observability
description: Observability requirements for MPLP including the 12 event
  families, normative emission rules, trace context compatibility, and metrics
  collection.
keywords:
  - observability
  - MPLP events
...
normative_id: MPLP-CC-OBS
permalink: /architecture/cross-cutting/observability
cross_cutting:
  - observability
normative_refs: []
protocol_alignment:
