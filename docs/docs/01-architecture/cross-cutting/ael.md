...
description: Action Execution Layer specification for MPLP runtime. Covers LLM
  API calls, tool invocation, agent handoffs, security sandboxing, and
...
normative_id: MPLP-CC-AEL
permalink: /architecture/cross-cutting/ael
cross_cutting:
  - ael
normative_refs: []
protocol_alignment:
  ...
  protocol_version: 1.0.0
  schema_refs:
    - schema_id: https://mplp.dev/schemas/v1.0/events/mplp-runtime-execution-event.schema.json
      binding: manual
  invariant_refs: []
  golden_refs: []
  code_refs:
