...
description: Learning and feedback mechanisms for MPLP including sample
  collection, PII anonymization, implicit/explicit feedback capture, and
  training data export for RLHF/SFT.
keywords:
  - learning feedback
  - training samples
  - RLHF
...
schema_version: v2
normative_id: MPLP-CORE-LEARNING-FEEDBACK
sidebar_position: 11
---
> [!FROZEN]
...
**Architecture**:
- [L2 Coordination](../l2-coordination-governance.md) - Feedback sources
- [Observability](observability.md) - Event-based collection

**Modules**:
- [Plan Module](../../02-modules/plan-module.md) - Intent events
- [Confirm Module](../../02-modules/confirm-module.md) - Approval signals
- [Dialog Module](../../02-modules/dialog-module.md) - Natural language feedback

**Schemas**:
- `schemas/v2/learning/mplp-learning-sample.schema.json`
