...
description: Normative conventions for MPLP JSON Schemas including naming rules,
  metadata standards, extensibility patterns, validation strategies, and
...
protocol_alignment:
  ...
  schema_refs:
    - schema_id: https://schemas.mplp.dev/v1.0/common/common-types.schema.json
      binding: manual
  invariant_refs: []
  golden_refs: []
  code_refs:
...
normative_id: MPLP-CORE-SCHEMA-CONVENTIONS
sidebar_position: 7
---
> [!FROZEN]
