...
description: L4 optional integration layer for external systems including IDE,
  Git, CI/CD, and tool integration. Defines 4 event schemas and 17 invariant
  rules for MPLP interoperability.
keywords:
  - L4 Integration
  - IDE integration
  - Git events
...
spec_level: L4
normative_id: MPLP-L4-INTEG
permalink: /architecture/l4-integration-infra
normative_refs: []
protocol_alignment:
  truth_level: T2
  protocol_version: 1.0.0
  schema_refs:
    - schema_id: https://mplp.dev/schemas/v1.0/integration/mplp-tool-event.json
      binding: manual
    - schema_id: https://mplp.dev/schemas/v1.0/integration/mplp-ci-event.json
      binding: manual
  invariant_refs: []
  golden_refs: []
  code_refs:
