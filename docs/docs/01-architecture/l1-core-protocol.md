...
description: L1 Core Protocol layer specification defining 29 JSON Schemas, 59 invariant rules, type definitions, and validation requirements for MPLP v1.0 compliance.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, L1 Core Protocol, JSON Schema, MPLP schemas, invariants, UUID v4, validation rules, protocol types, AJV]
