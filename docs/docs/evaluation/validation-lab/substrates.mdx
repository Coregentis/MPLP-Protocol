...
> **SSOT**: [`Validation_Lab/data/curated-runs/substrate-index.yaml`](https://github.com/Coregentis/MPLP-Protocol/blob/main/Validation_Lab/data/curated-runs/substrate-index.yaml)  
...
The substrate list evolves as new evidence is curated. See the [SSOT index](https://github.com/Coregentis/MPLP-Protocol/blob/main/Validation_Lab/data/curated-runs/substrate-index.yaml) for the authoritative, up-to-date list.
:::
