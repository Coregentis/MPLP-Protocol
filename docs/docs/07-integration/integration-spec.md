...
description: Specification for the MPLP Integration Layer (L4). Defines
  structured events for IDE, CI, Git, and external tool integration with MPLP
  runtimes.
keywords:
  - Integration Layer
  - MPLP L4
