...
> [!IMPORTANT]
> **Sovereignty #1: Agentic State Sovereignty**
>
> The PSG is a **Protocol Asset**. The Runtime is strictly a **Custodian**.
> *   **Runtime Rights**: Read, Append, Update (per L2 rules).
> *   **Runtime Prohibitions**: The Runtime MUST NOT define private state schemas, hide state from the PSG, or treat the PSG as an internal memory model. All state must be visible and standard.

## 5. Compliance

All MPLP-conformant runtimes must maintain a PSG that is:
