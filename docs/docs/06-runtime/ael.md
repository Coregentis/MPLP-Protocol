...
description: Action Execution Layer specification for MPLP runtime. Covers LLM API calls, tool invocation, agent handoffs, security sandboxing, and observability event emission.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, AEL, Action Execution Layer, LLM execution, tool invocation, agent handoff, sandboxing, runtime execution, MPLP runtime]
sidebar_label: AEL
---
> [!FROZEN]
...
- [L1-L4 Deep Dive](../01-architecture/l1-l4-architecture-deep-dive.md)
