...
description: Overview of MPLP Runtime Glue (L3). Defines how protocol elements
  are realized at runtime through the Project Semantic Graph (PSG) and event
  emission.
keywords:
...
normative_id: MPLP-RT-RUNTIME-GLUE-OVERVIEW
sidebar_position: 1
---
> [!FROZEN]
