...
description: Specification of MPLP Crosscutting Concerns (coordination,
  error-handling, etc.) and their binding to PSG state and Observability events.
keywords:
  - Crosscut PSG Binding
  - MPLP crosscutting concerns
  - coordination
  - error handling
  - event bus
  - orchestration
...
normative_id: MPLP-RT-CROSSCUT-PSG-EVENT-BINDING
sidebar_position: 3
---
> [!FROZEN]
