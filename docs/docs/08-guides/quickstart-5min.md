---
title: Quickstart 5Min
description: 5-minute quickstart guide for MPLP. Learn to validate protocol
  schemas and run a basic single-agent flow using the Reference Runtime and
  TypeScript SDK.
keywords:
  - Quickstart
  - MPLP tutorial
