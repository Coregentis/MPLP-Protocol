...
description: Technical details of the MPLP Golden Test Suite. Covers test scope, flow catalog, cross-language harness architecture (TS/Python), CI integration, and how to run tests.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Golden Test Suite Details, MPLP testing harness, cross-language testing, CI integration, running tests, flow catalog]
...
**Expected Outcome**: SA Profile conformant
...
**Expected Outcome**: MAP Profile conformant, turn-taking correct
