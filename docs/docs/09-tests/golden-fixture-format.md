...
description: Specification of the Golden Fixture Format for MPLP testing.
  Defines directory structure, input/output JSON formats, and strict comparison
  rules for validating runtime conformance.
keywords:
