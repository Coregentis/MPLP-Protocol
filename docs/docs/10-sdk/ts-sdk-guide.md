...
description: "Official guide for the MPLP TypeScript SDK (@mplp/sdk-ts). Covers installation, core components, quick start with builders, and Ajv-based validation."
