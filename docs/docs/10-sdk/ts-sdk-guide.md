...
description: "Reference guide for the MPLP TypeScript SDK (@mplp/sdk-ts). Covers installation, core components, quick start with builders, and Ajv-based validation."
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, TypeScript SDK Guide, MPLP TypeScript SDK, "@mplp/sdk-ts", Ajv validation, SDK builders, runtime engine, TypeScript quick start]
