...
description: Canonical mapping rules from MPLP JSON Schema v2 to TypeScript and
  Python models. Defines type system mappings, naming conventions, and
...
doc_role: guide
normative_id: MPLP-SDK-SCHEMA-MAPPING
normative_refs:
  - MPLP-CORPUS-v1.0.0
protocol_alignment:
  truth_level: T0D
