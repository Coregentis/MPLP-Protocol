...
description: Canonical mapping rules from MPLP JSON Schema v2 to TypeScript and Python models. Defines type system mappings, naming conventions, and validation result contracts.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Schema Mapping Standard, JSON Schema mapping, TypeScript models, Python Pydantic, cross-language consistency, validation result, type equivalence]
sidebar_label: Schema Mapping Standard
---
> [!FROZEN]
...
- **Stability**: This naming convention is a **v1.0 Protocol Invariant**. It MUST NOT be changed in minor versions.
...
## 11. Appendix A: Known Limitations

### 11.1 Date-Time Representation
...
### 11.2 Additional Properties in TypeScript
