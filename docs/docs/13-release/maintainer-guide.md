...
description: Guide for MPLP Protocol repository maintainers. Covers responsibilities, release processes for patch/minor/major versions, and frozen specification rules.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Maintainer Guide, MPLP maintainers, repository management, release process, semantic versioning, frozen specification, maintainer responsibilities]
