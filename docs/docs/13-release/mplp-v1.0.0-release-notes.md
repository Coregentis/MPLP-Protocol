...
description: Official Release Notes for MPLP v1.0.0. Highlights key features,
  protocol layers, event architecture, package structure, and installation
  instructions.
keywords:
  - Release Notes
  - MPLP v1.0.0
...
protocol_alignment:
  ...
  governance_alignment:
    ...
    process_refs: []
normative_id: MPLP-CORE-MPLP-V1-0-0-RELEASE-NOTES
sidebar_position: 1
---
> [!FROZEN]
