...
description: Normative invariants for MPLP Learning Samples. Defines validation
  rules for sample structure, required fields, and family-specific constraints
...
protocol_alignment:
  ...
  schema_refs:
    - schema_id: https://schemas.mplp.dev/v1.0/common/learning-sample.schema.json
      binding: manual
  invariant_refs:
    - local_path: schemas/invariants/learning-invariants.yaml
      binding: manual
  golden_refs:
    - local_path: tests/golden/flows/flow-05-learning-feedback/README.md
      binding: manual
  code_refs:
    ts: []
    py: []
...
schema_version: v2
normative_id: MPLP-LEARN-LEARNING-INVARIANTS
sidebar_position: 2
---
> [!FROZEN]
