...
description: Specification of Learning Collection Points in MPLP. Defines
  triggers and moments in the agent lifecycle (intent, execution, governance)
  for capturing learning samples.
keywords:
