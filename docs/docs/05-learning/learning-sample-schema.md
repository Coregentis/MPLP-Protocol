...
description: Reference for MPLP Learning Sample Schemas. Details the Core, Intent, and Delta schemas for structuring learning data from agent executions.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Learning Sample Schema, learning data format, MPLP schemas, intent sample, delta sample, core sample, learning data structure]
