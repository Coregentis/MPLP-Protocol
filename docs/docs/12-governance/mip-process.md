---
title: MIP Process
description: The MPLP Improvement Proposal (MIP) process. Guidelines for
  proposing new features, protocol changes, and community standards.
keywords:
  - MIP Process
  - MPLP Improvement Proposals
  - protocol governance
  - feature proposals
  - community standards
  - contribution guide
...
protocol_alignment:
  ...
  governance_alignment:
    ...
    process_refs: []
normative_id: MPLP-CORE-MIP-PROCESS
sidebar_position: 4
---
> [!FROZEN]
