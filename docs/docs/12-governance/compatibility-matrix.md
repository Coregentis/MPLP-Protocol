...
description: Official Compatibility Matrix for MPLP protocol versions, SDKs, and
  schemas. Defines cross-language interoperability and backward compatibility
  rules.
keywords:
  - Compatibility Matrix
  - MPLP protocol versions
  - SDK compatibility
...
protocol_alignment:
  ...
  governance_alignment:
    ...
    process_refs: []
normative_id: MPLP-CORE-COMPATIBILITY-MATRIX
sidebar_position: 5
---
> [!FROZEN]
