...
description: Official Security Policy for MPLP. Instructions for reporting
  vulnerabilities, response timelines, and scope of security coverage.
keywords:
  - Security Policy
  - MPLP security
...
protocol_alignment:
  ...
  governance_alignment:
    ...
    process_refs: []
normative_id: MPLP-CORE-SECURITY-POLICY
sidebar_position: 3
---
> [!FROZEN]
