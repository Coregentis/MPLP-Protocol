...
description: Guide to Vendor-Neutral LLM Integration in MPLP. Details the LlmClient interface, HttpLlmClient implementation, and how to achieve portability across LLM providers.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Vendor Neutral LLM, MPLP integration, LlmClient interface, LLM portability, HttpLlmClient, provider agnostic, AI integration]
sidebar_label: Vendor Neutral LLM Integration
---
> [!FROZEN]
