...
> **Status**: **VERIFIED**
> 
> This example demonstrates the normative error detection and recovery patterns as defined in the MPLP v1.0.0 specification.
...
Errors must propagate from the L3 Execution layer to the L2 Trace layer. A compliant runtime must ensure that the `root_span` of the Trace correctly reflects the aggregate status of its segments.
...
- [Trace Module Specification](../02-modules/trace-module.md)
- [L3 Error Handling & Drift](../01-architecture/l3-execution-orchestration.md)
- [Golden Flow: Resilient Execution](../06-golden-flows/gf-01.mdx)
