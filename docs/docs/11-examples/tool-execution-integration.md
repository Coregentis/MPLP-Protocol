...
description: Complete guide to Tool Execution Integration in MPLP. Explains the ToolExecutor interface, sandboxing, auditability, and integration with the MPLP Runtime.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Tool Execution Integration, MPLP tools, ToolExecutor interface, sandboxing, auditability, runtime integration, tool invocation]
sidebar_label: Tool Execution Integration
---
> [!FROZEN]
