...
description: "Reference for the 3 Physical Event Schemas in MPLP:
  GraphUpdateEvent, PipelineStageEvent, and RuntimeExecutionEvent. Defines
  structural requirements for core event families."
keywords:
  - Physical Schemas
  - GraphUpdateEvent
  - PipelineStageEvent
...
normative_id: MPLP-OBS-PHYSICAL-SCHEMAS-REFERENCE
sidebar_position: 5
---
> [!FROZEN]
