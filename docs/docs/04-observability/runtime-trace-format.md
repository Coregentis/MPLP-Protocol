...
description: Specification of the MPLP Runtime Trace Format. Defines the JSON
  structure for exporting execution data, compatible with W3C Trace Context and
  OpenTelemetry.
keywords:
