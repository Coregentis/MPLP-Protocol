...
description: MPLP Event Taxonomy defining the 12 Event Families for
  observability. Classifies events into Intent & Planning, Execution &
  Lifecycle, and State & Safety groups.
keywords:
  - Event Taxonomy
  - MPLP events
  - event families
...
normative_id: MPLP-OBS-EVENT-TAXONOMY
sidebar_position: 3
---
> [!FROZEN]
