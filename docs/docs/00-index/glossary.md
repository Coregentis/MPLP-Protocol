...
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, MPLP glossary, protocol terminology, Context, Plan, Trace, Confirm, PSG, SA Profile, MAP Profile, multi-agent terms]
