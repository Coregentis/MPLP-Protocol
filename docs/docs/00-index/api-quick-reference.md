...
description: Quick reference guide for MPLP v1.0 API components including 10 core modules, 12 event families, execution profiles, SDK installation, and schema references.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, MPLP API, protocol reference, core modules, event families, SDK reference, JSON schema, TypeScript SDK, Python SDK]
