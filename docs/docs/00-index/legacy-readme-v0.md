...
[![License](https://img.shields.io/badge/License-Apache_2.0-green?style=flat-square)](/MPLP-Protocol/)
...
[![Profiles](https://img.shields.io/badge/Profiles-SA_%7C_MAP-orange?style=flat-square)](/MPLP-Protocol/profiles/)
[![Schema](https://img.shields.io/badge/Schema-JSON_Schema_v1.0-purple?style=flat-square)](https://github.com/Coregentis/MPLP-Protocol/tree/main/schemas/v2)
...
[**Documentation**](/MPLP-Protocol/) • [**Schemas**](https://github.com/Coregentis/MPLP-Protocol/tree/main/schemas/v2) • [**Examples**](https://github.com/Coregentis/MPLP-Protocol/tree/main/examples) • [**SDKs**](https://github.com/Coregentis/MPLP-Protocol/tree/main/packages) • [**Governance**](/MPLP-Protocol/governance/)
...
## 2. Core Capabilities (What MPLP Adds to the Stack)
...
* **L2: Modules & Crosscuts**
  ...
  * 11 cross-cutting kernel duties (Coordination, Observability, Security, State Sync, etc.)
...
## 5. Ten Modules: The Infrastructure of Agent Systems
...
## 6. Profiles: The Runtime Contract (SA & MAP)
...
## 8. Golden Flows — How We Prove It Works
