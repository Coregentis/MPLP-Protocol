...
description: Navigate MPLP v1.0 documentation by role. Find reading paths for
  runtime implementers, system architects, SDK users, test engineers, and
...
1. **Compliance Requirements**:
   - [Compliance Guide](../08-guides/mplp-v1.0-compliance-guide.md) - 3 compliance levels
   - [Compliance Checklist](../08-guides/mplp-v1.0-compliance-checklist.md) - Self-assessment

2. **Core Specifications**:
   - [SA Profile](../03-profiles/sa-profile.md) - **should**: 9 invariants
...
4. **Observability** (**should** for compliance):
...
2. **Cross-Cutting Concerns**:
   - [Observability](../01-architecture/cross-cutting/observability.md)
   - [Security](../01-architecture/cross-cutting/security.md)
   - [State Sync](../01-architecture/cross-cutting/state-sync.md)
   - [Transaction](../01-architecture/cross-cutting/transaction.md)
   - [Event Bus](../01-architecture/cross-cutting/event-bus.md)
   - [Orchestration](../01-architecture/cross-cutting/orchestration.md)
...
**SDK Reference**:
- [SDK Support Matrix](../10-sdk/sdk-support-matrix.md) - Language coverage
...
docs/
 ...
 01-architecture/     # 4-layer architecture (L1-L4)    architecture-overview.md    l1-core-protocol.md    l2-coordination-governance.md    l3-execution-orchestration.md    l4-integration-infra.md    schema-conventions.md    cross-cutting/   # 9 cross-cutting concerns 
 ...
 06-runtime/          # L3 runtime specs    runtime-glue-overview.md    crosscut-psg-event-binding.md    drift-and-rollback.md    drift-and-rollback.md 
 07-integration/      # L4 integration (optional)    integration-spec.md    integration-spec.md    integration-spec.md 
...
- `events/mplp-pipeline-stage-event.schema.json` (should)
- `events/mplp-graph-update-event.schema.json` (should)
