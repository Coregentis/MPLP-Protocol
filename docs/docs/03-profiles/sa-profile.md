---
title: Sa Profile
description: Single-Agent (SA) Profile specification as the baseline execution
  mode for MPLP. Defines minimal modules, invariants, and lifecycle for
  autonomous agents.
keywords:
  - SA Profile
...
spec_level: L2
normative_id: MPLP-PROF-SA
permalink: /profiles/sa-profile
normative_refs: []
protocol_alignment:
  truth_level: T2
  protocol_version: 1.0.0
  schema_refs:
    - schema_id: https://mplp.dev/schemas/v1.0/events/mplp-sa-event.schema.json
      binding: manual
    - schema_id: https://schemas.mplp.dev/v1.0/mplp-context.schema.json
      binding: manual
  invariant_refs:
    - local_path: tests/golden/invariants/sa.yaml
      binding: manual
  golden_refs:
    - local_path: tests/golden/flows/sa-flow-01-basic/README.md
      binding: manual
  code_refs:
    ts: []
    py: []
