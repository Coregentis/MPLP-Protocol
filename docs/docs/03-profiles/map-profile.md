---
title: Map Profile
description: Multi-Agent (MAP) Profile specification extending SA Profile.
  Introduces coordination mechanisms, turn-taking, and shared state management
...
spec_level: L2
normative_id: MPLP-PROF-MAP
permalink: /profiles/map-profile
normative_refs: []
protocol_alignment:
  truth_level: T2
  protocol_version: 1.0.0
  schema_refs:
    - schema_id: https://mplp.dev/schemas/v1.0/events/mplp-map-event.schema.json
      binding: manual
    - schema_id: https://schemas.mplp.dev/v1.0/mplp-collab.schema.json
      binding: manual
  invariant_refs: []
  golden_refs:
    - local_path: tests/golden/flows/map-flow-01-turn-taking/README.md
      binding: manual
  code_refs:
    ts: []
    py: []
