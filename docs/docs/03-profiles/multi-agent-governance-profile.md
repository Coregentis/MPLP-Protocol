...
description: Multi-Agent Governance Profile defining rules for order and safety
  in agent systems. Covers centralized, federated, and hierarchical models,
...
normative_id: MPLP-CORE-MULTI-AGENT-GOVERNANCE-PROFILE
sidebar_position: 5
---
> [!FROZEN]
...
**Cross-Cutting**:
- [Security](../01-architecture/cross-cutting/security.md) - Security controls
- [Coordination](../01-architecture/cross-cutting/coordination.md) - Collaboration modes
