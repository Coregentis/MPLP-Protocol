---
title: Trace Module
description: Trace Module specification for MPLP observability. Captures
  immutable execution history as W3C-compatible spans and segments for auditing
  and debugging.
keywords:
  - Trace Module
  - observability
...
spec_level: L2
normative_id: MPLP-MOD-TRACE
permalink: /modules/trace-module
modules:
  - trace
normative_refs: []
protocol_alignment:
  ...
  schema_refs:
    - schema_id: https://schemas.mplp.dev/v1.0/mplp-trace.schema.json
      local_path: packages/sdk-ts/schemas/mplp-trace.schema.json
...
**From**: `docs/01-architecture/cross-cutting/observability.md`
...
- [Observability](../01-architecture/cross-cutting/observability.md) - Event families

**Modules**:
- [Context Module](context-module.md) - Parent Context binding
- [Plan Module](plan-module.md) - Associated Plan
- [Learning Overview](../05-learning/learning-overview.md) - Sample extraction from traces
