---
title: Trace Module
description: Trace Module specification for MPLP observability. Captures immutable execution history as W3C-compatible spans and segments for auditing and debugging.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Trace Module, observability, execution history, W3C trace, audit trail, immutable trace, debugging, performance analysis]
