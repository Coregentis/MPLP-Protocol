---
title: Collab Module
description: Collab Module specification for MPLP multi-agent coordination.
  Covers broadcast, round-robin, orchestrated, swarm, and pair modes for MAP
  profile execution.
keywords:
  - Collab Module
...
spec_level: L2
normative_id: MPLP-MOD-COLLAB
permalink: /modules/collab-module
modules:
  - collab
normative_refs: []
protocol_alignment:
...
- [Coordination](../01-architecture/cross-cutting/coordination.md) - MAP modes detail
