...
doc_type: normative
trace:
  schema: schemas/v2/modules/mplp-role.schema.json
  tests: packages/sources/sdk-ts/__tests__/role.test.ts
title: Role Module
description: Role Module specification for MPLP Role-Based Access Control (RBAC). Defines agent capabilities, permission boundaries, and behavioral identities.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Role Module, RBAC, agent capabilities, permission boundaries, role definitions, access control, MPLP security]
