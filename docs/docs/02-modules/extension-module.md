...
doc_type: normative
trace:
  schema: schemas/v2/modules/mplp-extension.schema.json
  tests: packages/sources/sdk-ts/__tests__/extension.test.ts
title: Extension Module
description: Extension Module specification for MPLP plugin system. Enables capability injection, policy enforcement, and integrations through a standardized extension mechanism.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Extension Module, plugin system, MPLP extensions, capability injection, policy enforcement, integration, transformation]
