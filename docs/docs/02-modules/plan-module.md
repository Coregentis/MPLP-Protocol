---
title: Plan Module
description: Plan Module specification for MPLP task decomposition. Defines the
  Plan object as a Directed Acyclic Graph (DAG) of executable steps with
...
spec_level: L2
normative_id: MPLP-MOD-PLAN
permalink: /modules/plan-module
modules:
  - plan
normative_refs: []
protocol_alignment:
  ...
  schema_refs:
    - schema_id: https://schemas.mplp.dev/v1.0/mplp-plan.schema.json
      local_path: packages/sdk-ts/schemas/mplp-plan.schema.json
...
- [Orchestration](../01-architecture/cross-cutting/orchestration.md) - DAG execution

**Modules**:
- [Context Module](context-module.md) - Parent Context binding
- [Confirm Module](confirm-module.md) - Approval workflow
- [Trace Module](trace-module.md) - Execution tracing
- [Role Module](role-module.md) - agent_role reference

**Cross-Cutting**:
- [Error Handling](../01-architecture/cross-cutting/error-handling.md) - Step failure handling
