...
doc_type: normative
trace:
  schema: schemas/v2/modules/mplp-context.schema.json
  tests: packages/sources/sdk-ts/__tests__/context.test.ts
title: Context Module
description: Context Module specification for MPLP project state. Defines the root anchor for Plans, Traces, and Roles, encapsulating domain, environment, and constraints.
keywords: [MPLP, Multi-Agent Lifecycle Protocol, Agent OS Protocol, AI Agent, Observable, Governed, Vendor-neutral, Context Module, project state, world state, root anchor, MPLP context, environment definition, domain constraints]
