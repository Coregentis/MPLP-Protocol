...
description: Network Module specification for MPLP multi-agent topologies.
  Defines node collections and connection patterns like hub-spoke and mesh for
...
spec_level: L2
normative_id: MPLP-MOD-NETWORK
permalink: /modules/network-module
modules:
  - network
normative_refs: []
protocol_alignment:
  ...
  protocol_version: 1.0.0
  schema_refs:
    - schema_id: https://schemas.mplp.dev/v1.0/mplp-network.schema.json
      local_path: packages/sdk-ts/schemas/mplp-network.schema.json
...
- [Coordination](../01-architecture/cross-cutting/coordination.md)

**Modules**:
- [Context Module](context-module.md) - Parent Context binding
- [Collab Module](collab-module.md) - Agent collaboration
- [Role Module](role-module.md) - Node capabilities
