...
|--------|------|-------------|
| [ ] | Context schema validation | ✅ REQUIRED |
| [ ] | `context_id` (UUID v4) | ✅ REQUIRED |
| [ ] | `timestamp` (ISO 8601) | ✅ REQUIRED |
| [ ] | `title` (non-empty string) | ✅ REQUIRED |
| [ ] | `constraints` support | ⚠️ RECOMMENDED |
...
| Status | Item | Requirement |
|--------|------|-------------|
| [ ] | Plan schema validation | ✅ REQUIRED |
| [ ] | `plan_id` (UUID v4) | ✅ REQUIRED |
| [ ] | `context_id` reference | ✅ REQUIRED |
| [ ] | `steps[]` array | ✅ REQUIRED |
| [ ] | Each step has `step_id`, `description`, `agent_role` | ✅ REQUIRED |
| [ ] | `dependencies[]` support | ✅ REQUIRED |
| [ ] | `agent_role` polymorphism | ✅ REQUIRED |
...
| Status | Item | Requirement |
|--------|------|-------------|
| [ ] | Confirm schema validation | ✅ REQUIRED |
| [ ] | `confirm_id` (UUID v4) | ✅ REQUIRED |
| [ ] | `target_plan` reference | ✅ REQUIRED |
| [ ] | `decisions[]` array | ✅ REQUIRED |
| [ ] | Multi-round approval support | ✅ REQUIRED |
...
| Status | Item | Requirement |
|--------|------|-------------|
| [ ] | Trace schema validation | ✅ REQUIRED |
| [ ] | `trace_id` (UUID v4) | ✅ REQUIRED |
| [ ] | `context_id` reference | ✅ REQUIRED |
| [ ] | `events[]` array (spans) | ✅ REQUIRED |
| [ ] | Hierarchical spans (parent-child) | ⚠️ RECOMMENDED |
| [ ] | `timestamp` on all events | ✅ REQUIRED |
