/**
 * MPLP Basic Coordination Example Type Definitions
 *
 * Multi-agent coordination example based on MPLP v1.0 Alpha actual Schema
 * Uses Context + Plan + Trace modules to demonstrate coordination features
 * Follows dual naming convention: Schema layer(snake_case) ↔ TypeScript layer(camelCase)
 *
 * @author MPLP Community
 * @version 1.0.0-alpha
 */

// ===== Type definitions based on actual MPLP Schema =====
// Reference: src/schemas/core-modules/mplp-context.json
// Reference: src/schemas/core-modules/mplp-plan.json
// Reference: src/schemas/core-modules/mplp-trace.json
