...
# Module → Event Emission Matrix (MPLP v1.0)

**Purpose**: Define which event families MUST or SHOULD be emitted by each MPLP core component.

**Scope**: 10 L2 modules + PSG (Project Semantic Graph) + Pipeline Controller
