...
- [Integration Patterns](../07-integration/integration-patterns.md) - Runtime integration
...
For questions or contributions, see [Contributing Guide](../../docs/99-meta/archive/CONTRIBUTING.md).
---
