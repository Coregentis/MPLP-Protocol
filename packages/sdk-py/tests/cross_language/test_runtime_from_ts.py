...
class TestRuntimeFromTs:
    ...
    def test_invariants(self):
        ...
        with open(RUNTIME_OUT_TS_DIR / "context.json") as f: ctx = json.load(f)
        with open(RUNTIME_OUT_TS_DIR / "plan.json") as f: plan = json.load(f)
        with open(RUNTIME_OUT_TS_DIR / "confirm.json") as f: confirm = json.load(f)
        with open(RUNTIME_OUT_TS_DIR / "trace.json") as f: trace = json.load(f)
