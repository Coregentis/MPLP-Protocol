...
export declare const PACKAGE_NAME: "@mplp/coordination";
export declare const PACKAGE_VERSION: "1.0.7";
export declare const MPLP_PROTOCOL_VERSION: "1.0.0";
export declare const PACKAGE_ROLE: "coordination-helper";
export declare const CONTRACT_MODE: "derived-protocol-helper";
