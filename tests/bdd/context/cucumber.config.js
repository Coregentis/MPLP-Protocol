...
const config = {
  // 功能文件路径
  features: [
    'tests/bdd/context/*.feature'
  ],
  
  // 步骤定义文件路径
  glue: [
    'tests/bdd/context/step-definitions/*.ts'
  ],
  ...
  hooks: {
    beforeAll: async function() {
      console.log('🚀 开始Context模块BDD测试');
      console.log('📋 基于MPLP智能体构建框架协议标准');
    },
    
    afterAll: async function() {
      console.log('✅ Context模块BDD测试完成');
    },
  ...
  reporting: {
    ...
    // 报告输出目录
    outputDirectory: 'tests/bdd/context/reports',
